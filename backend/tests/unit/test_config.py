...
class TestSettings:
    ...
    def test_default_settings(self):
        ...
        # Database
        assert settings.database_url == "postgresql+asyncpg://notemesh:password@localhost:5432/notemesh"
        ...
        assert settings.allowed_file_extensions == [".jpg", ".jpeg", ".png", ".gif", ".pdf", ".txt", ".md"]
