...
class NoteCreate(BaseModel):
    ...
    hyperlinks: List[HttpUrl] = Field(default_factory=list, max_items=50, description="External hyperlinks")
    ...
    class Config:
        json_schema_extra = {
            "example": {
                ...
                "hyperlinks": ["https://wiki.company.com", "https://docs.google.com/spreadsheets/d/123"],
                "is_public": False
            }
        }
...
class NoteUpdate(BaseModel):
    ...
    title: Optional[str] = Field(default=None, min_length=1, max_length=200, description="Note title")
    ...
    hyperlinks: Optional[List[HttpUrl]] = Field(default=None, max_items=50, description="External hyperlinks")
...
class NoteListResponse(PaginationResponse[NoteListItem]):
    ...
    available_tags: Optional[List[str]] = Field(default=None, description="Available tags for filtering")
